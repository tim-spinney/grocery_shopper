...
void _recipeSerialize(
  ...
  writer.writeLong(offsets[1], object.servings);
...
Recipe _recipeDeserialize(
  ...
  object.servings = reader.readLongOrNull(offsets[1]);
...
Ingredient _ingredientDeserialize(
  ...
  object.unit =
      _IngredientunitValueEnumMap[reader.readByteOrNull(offsets[2])] ??
          ItemUnit.Gram;
  return object;
}
